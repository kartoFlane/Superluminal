...
public class CursorBox extends PaintBox implements DraggableBox {
	...
	public void paintControl(PaintEvent e) {
		...
		if ((Main.tltmPointer.getSelection() || Main.tltmGib.getSelection()) && borderColor != null) {
			...
			toolMount.slide = Main.mountToolSlide;
			toolMount.setRotated(Main.mountToolHorizontal);
			toolMount.setMirrored(Main.mountToolMirror);
			toolMount.setLocation(Main.mousePos.x, Main.mousePos.y);
			
			toolMount.paintControl(e);
	...
	public void mouseUp(MouseEvent e) {
		...
		if (Main.tltmDoor.getSelection() && Main.selectedDoor != null) {
			if (Main.selectedDoor.getBounds().contains(Main.mousePos))
				return;
	...
	public void mouseDown(MouseEvent e) {
		...
		if (Main.tltmDoor.getSelection()) {
			...
			if (Main.modShift) {
				...
				if (Main.selectedDoor != null)
					Main.selectedDoor.selectNoMove();
			}
		}
	}
